<div id="panel" class="panel panel-default fondo">
    <div class="panel-heading" style="background-color: rgba(256,256,256,.1);">
          <center> <h3 id="nombre-tabla" class="text-danger text">Mis Reservas de Elementos</h3></center>
    </div>
 
    <ul class="nav nav-tabs">
      <li class="active"><a data-toggle="tab" href="#mis">mis Reservas Elementos</a></li>
      <li><a data-toggle="tab" href="#general">Reservas Elementos General</a></li>
    </ul>
                ...
                <table class="table table-bordered cell-border table-hover" id="tabla2">
                    ...
                    <tbody>
                        ...
                        <tr class="@if($telementos2->usuario_id == Auth::user()->id) text-primary @endif
                            ...
                            <td class="text-center">{{ $telementos2->elemento.' cant. ('.$telementos2->cantidad.')' }}</td>
