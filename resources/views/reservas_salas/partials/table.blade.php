<div id="panel" class="panel panel-default fondo">
    <div class="panel-heading" style="background-color: rgba(256,256,256,.1);">
          <center> <h3 id="nombre-tabla" class="text-danger text">Control de Reservas de Salas</h3>
    </div>
                        
      <div class="panel-body">
        <div class="dataTable_wrapper">
          <div class="container-fluid table-responsive">
          <a class="btn btn-primary pull-right" href="{{ url('/reservaSalas/create') }}" role="button"><span class="glyphicon glyphicon-plus"></span> Reservas</a>
    ...
    {!! Form::open(['route' => ['reservaSalas.destroy', $telementos->id], 'method' => 'DELETE']) !!}
                    <td class="text-center">
                        <button type="submit" class="btn btn-danger btn-xs">
                            <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                        </button>
                        <a href="{{ url('/reservaSalas/'.$telementos->id.'/edit')}}" class="btn btn-info btn-xs">
                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                        </a> 
                          <a href="{{ url('/confirmarSala/'.$telementos->id) }}" class="btn @if($telementos->confirmar == 1) ocultar @endif btn-success btn-xs">
